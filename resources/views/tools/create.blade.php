                ...
                <form action="{{ route('create_post.post') }}" method="POST" enctype="multipart/form-data" id="listing-form">
                    ...
                    <section class="form-section">
                        ...
                        <div class="field-grid">
                            ...
                            <div class="field full-field">
                                <label for="location">محل سکونت</label>
                                <input class="form-control" id="location" name="location" type="text" maxlength="80" value="{{ old('location') }}"
                                    placeholder="به طور مثال: تهران، خیابان ولیعصر" required>
                                <span class="field-hint">محل سکونت خود را به طور کلی بیان کنید.</span>
